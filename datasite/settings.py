...
SECRET_KEY = 'o0)tmw0z)377ke($so)tp%e3p!c*90q*89l!ssmv_ddv(8h@*^'
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR/'templates',
                 os.path.join('chpa/templates'),
                 os.path.join('disk/templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
